...
summary: Cloud Data Sense可在您的磁碟區、Amazon S3儲存區、資料庫、OneDrive資料夾和SharePoint帳戶中識別許多類型的私有資料。請參閱下列類別。 
---
= 私有資料類別
:hardbreaks:
:allow-uri-read: 
...
[role="lead"]
Cloud Data Sense可在您的磁碟區、Amazon S3儲存區、資料庫、OneDrive資料夾和SharePoint帳戶中識別許多類型的私有資料。請參閱下列類別。
...
.CSV、.dcm、.dicom、.dDOC、.DOCX、 .Json、.PDF、.PPTX、.RTF、.TXT、 .XLS和.XLSX.+
